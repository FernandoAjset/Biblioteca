...
public class EliminarP extends javax.swing.JFrame {
    ...
    public EliminarP() {
        ...
        if (id > 0) {
            ...
            int cantidad=MetodosProducto.CantidadStock(id);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("PRESIONE VER LISTADO PARA SELECCIONAR UN PRODUCTO A ELIMINAR");
    ...
    private void listadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listadoActionPerformed
        ListaProductos.ventanaAnterior = "eliminarP";
